<template>
    <div class="user-card">
        ...
        <div class="details">
            ...
            <span class="post"><span>Toplam Gönderi </span><span> {{totalS.totalQuestion}}</span></span>
            <span class="likey"><span>Toplam Beğeni </span><span>{{totalS.totalLike}}</span></span>
            <span class="dislike"><span>Toplam Dislike </span><span>{{totalS.totalDislike}}</span></span>
        </div>
    </div>
</template>
